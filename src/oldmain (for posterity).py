...
def polar_to_motor(point):
    ...
    r = (r * 1000/math.sqrt(1000**2 + 500**2)) + MAPPING_VAL
...
def task_motor1 ():
    ...
    while True:
        ...
        if currpos1 < encoder1.read() + tolerance1 and currpos1 > encoder1.read() - tolerance1  and currpos2 < encoder2.read() + tolerance2 and currpos2 > encoder2.read() - tolerance2:
            finishedmove.put(1)
            print("finished_move")
...
def task_logic ():
    ...
    while True:
        ...
        elif contour_index < len(contours):
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            finishedmove = task_share.Share ('h', thread_protect = False, name = "keyShare")
            finishedmove.put(1)
